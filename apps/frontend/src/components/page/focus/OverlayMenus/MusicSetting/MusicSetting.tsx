...
export const MusicSetting = ({
  ...
  const soundSettingList = [
    {
      id: '1',
      title: getLabel('lbl_focus_010'),
      volume: rainVolumn,
      setVolume: setRainVolumn,
      source: '/focus/music/calming-rain.mp3'
    },
    {
      id: '2',
      title: getLabel('lbl_focus_011'),
      volume: ghibliVolumn,
      setVolume: setGhibliVolumn,
      source: '/focus/music/ghibli.mp3'
    },
    {
      id: '3',
      title: getLabel('lbl_focus_012'),
      volume: fireVolumn,
      setVolume: setFireVolumn,
      source: '/focus/music/fire.mp3'
    },
    {
      id: '4',
      title: getLabel('lbl_focus_013'),
      volume: ambienceVolumn,
      setVolume: setAmbienceVolumn,
      source: '/focus/music/ambience.mp3'
    }
  ];
