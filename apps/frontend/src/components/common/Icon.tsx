...
export function ProjectsAltFill({
  className,
  ...rest
}: IconProps): JSX.Element {
  return (
...
export function FlagForVietnam({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 64 64"
...
export function FlagForUnitedKingdom({
  className,
  ...rest
}: IconProps): JSX.Element {
  return (
...
export function Eye({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function EyeOff({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function RoundLogout({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function BaselineAddCircle({
  className,
  ...rest
}: IconProps): JSX.Element {
  return (
...
export function SettingsFill({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function YoutubeFilled({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    ...
    >
      <path
        fill="#FF0000"
        d="M256.972 106.668c12.12.02 134.11.444 165.706 8.901c18.368 4.876 32.81 19.29 37.738 37.731
          c8.56 31.948 8.903 97.106 8.917 102.268v.653c-.014 5.177-.356 70.53-8.917 102.479
          c-4.928 18.441-19.37 32.855-37.738 37.73c-32.594 8.725-161.381 8.9-166.52 8.903h-.316
          c-5.14-.003-133.947-.178-166.562-8.903c-18.346-4.875-32.81-19.289-37.717-37.73
          c-8.54-31.949-8.882-97.302-8.896-102.48v-.652c.014-5.162.356-70.32 8.896-102.268
          c4.907-18.441 19.37-32.855 37.717-37.73c31.616-8.458 153.627-8.881 165.749-8.902Z"
      />
      <path fill="#FFFFFF" d="M212.352 192.938v126.123l111.53-63.167z" />
    </svg>
  );
}

export function LinkSolid({ className, ...rest }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
