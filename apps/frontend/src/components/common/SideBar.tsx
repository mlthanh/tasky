  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="header"
        className={tailwindMerge('flex flex-col gap-2 p-2', className)}
        {...props}
      />
    );
  }
...
const SidebarMenu = forwardRef<HTMLUListElement, ComponentProps<'ul'>>(
  ({ className, ...props }, ref) => (
    <ul
      ref={ref}
      data-sidebar="menu"
      className={tailwindMerge('flex w-full min-w-0 flex-col gap-1', className)}
      {...props}
    />
  )
);
...
const SidebarMenuItem = forwardRef<HTMLLIElement, ComponentProps<'li'>>(
  ({ className, ...props }, ref) => (
    <li
      ...
      className={tailwindMerge('group/menu-item relative', className)}
      {...props}
    />
  )
);
